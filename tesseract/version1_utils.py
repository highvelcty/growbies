...
def make_training_for_full_black_white_picture():
    data = [
        ('A7C06794', 0, 3.065),
        ('A7C06818', 197, 2.932),
        ('A7C06827', 209, 2.920),
...
def conversion_to_binary_black_and_white():
    path = Path('/home/meyer/code/tesstrain/data/scale-ground-truth')
    for picture in path.iterdir():
...
def read_cropped_scale_and_mmd():
    path = Path('/home/meyer/tmp/velo_compare_1/')
