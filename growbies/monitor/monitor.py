        ...
        for retry in range(OSERROR_RETRIES):
            ...
            try:
                ...
                while True:
                    ...
                    data = arduino_serial.read_grams()
                    ...
                    out_str = (f'{ts}, {data.sensor[0].mass_a.data}, {data.sensor[0].mass_b.data}, '
                               f'{data.sensor[0].mass.data}, {data.sensor[0].temperature.data}')
                    file_str = out_str
