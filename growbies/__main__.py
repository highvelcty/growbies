...
from . import db, exec, human_input, monitor, plot, sample, service
...
class Level1Cmd(StrEnum):
    ...
    DB = RepoPaths.GROWBIES_DB.value.name
...
for pkg in (db, exec, human_input, monitor, plot, sample, service):
